...
cd /home/gabriel/dev/SCIA/data-eng-project/data-pipeline/spark
...
docker-compose -f src/docker-compose-kafka.yml up -d
...
LOG_FILE="/home/gabriel/dev/SCIA/data-eng-project/robust_test_consumer.log"
...
echo "  Containers: docker-compose -f src/docker-compose-kafka.yml down"
